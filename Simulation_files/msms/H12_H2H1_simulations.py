...
# Updated, Mariana Harris 2021
# The script calculates H12 and H2/H1 from simulated data (msms)
...
def clusterSingleWindow(inFile, outFile, windowTot, distanceThreshold, numStrains, singleWindow, basePair, locusLength, PF, Nac, sel, age, numsnps,downSampleWindow):
...
def main():
    ...
    if singleWindow !=-100:
        clusterSingleWindow(inFile, outFile, windowTot, distanceThreshold, numStrains, singleWindow, basePair, locusLength, PF, Nac, sel, age, numsnps,downSampleWindow)
    else:
