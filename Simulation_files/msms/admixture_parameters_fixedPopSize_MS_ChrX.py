...
adaptive_theta=float(sys.argv[2])*0.75
...
for i in range(0, numberOfSimulations):
    ...
    Nea = EUr*propX
    Nnc = NAm*propX
    Nna =  NAm*propX# need to unlog code
    ...
    scaledNeAfricaBottleneck=(1000/10**sev)*propX/Nac # sev is in terms of duration/pop size, and duration is fixed at 1000 gen.
    ...
    if selection == 'True':
        command='java -jar ~/Applications/msms/lib/msms.jar  ' + str(totalSampleSize) + ' 1 -N ' + str(Nac) + ' -t ' +str(theta) +' -I 3 '+ str(sampleSizeAfrica) +' ' + str(sampleSizeEurope) +' ' +str(sampleSizeAmerica) +' -n 2 '+ str(scaledNeEurope) +' -g 2 ' + str(growthRateEurope) + ' -n 3 ' + str(scaledNeAmerica) + ' -g 3 ' + str(growthRateAmerica) 
        ...
        command='java -jar ~/Applications/msms/lib/msms.jar ' + str(totalSampleSize) + ' 1 -t ' +str(theta) +' -I 3 '+ str(sampleSizeAfrica) +' ' + str(sampleSizeEurope) +' ' +str(sampleSizeAmerica) +' -n 2 '+ str(scaledNeEurope) +' -g 2 ' + str(growthRateEurope) + ' -n 3 ' + str(scaledNeAmerica) + ' -g 3 ' + str(growthRateAmerica) 
        #command += ' -m 1 3 ' + str(M_NA) + ' -m 3 1 ' + str(M_NA) + ' -m 2 3 ' + str(M_NE) + ' -m 3 2 ' + str(M_NE)  
